package com.example.sharepreferenceso;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name  = sharedPref.getString("example_name","no name");
        String value = sharedPref.getString("list","abcdef");
        Toast.makeText(this, "HELLO: "+ name.toUpperCase(Locale.ROOT)+" "+value,Toast.LENGTH_SHORT).show();
